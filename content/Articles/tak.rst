...
.. figure:: {static}/images/knitr/games-tak-diagram-1.png
    :align: center
    :alt: Tak game diagram with traditional pieces
    :width: 60%
...
.. figure:: {static}/images/knitr/games-tak-stackpack-1.png
    :align: center
    :alt: Tak game diagram with stackpack pieces
    :width: 60%
