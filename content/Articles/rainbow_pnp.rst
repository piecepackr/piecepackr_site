...
.. figure:: {static}/images/knitr/demos-RD-RD1-1.png
    :align: center
    :alt: Rainbow Deck suited piecepack (Dark suits)
    :width: 60%
...
.. figure:: {static}/images/knitr/demos-RD-RD2-1.png
    :align: center
    :alt: Rainbow Deck suited piecepack (Light suits)
    :width: 60%
