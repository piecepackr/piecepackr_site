...
.. figure:: {static}/images/knitr/docs-configuration-example-1.png
    :align: center
    :alt: Configuration list example
    :width: 90%
...
::
    ...
    ## $copyright : © 2019 Trevor L Davis.  Some Rights Reserved. 
    ## $credit : ● This piecepack uses characters from the font Quivira. Public Domain.,	http://www.quivira-font.com/ 
    ## $description :  
    ## $fontfamily : Quivira 
    ## $invert_colors.suited : TRUE 
    ## $lacks_rank : tile_back,coin_back,card_back,pawn_face,pawn_back,belt_face,saucer_face,saucer_back,suitdie_face 
    ## $lacks_suit : tile_back,saucer_back,coin_face,card_back 
    ## $n_ranks : 6 
    ## $n_suits : 4 
    ## $rank_text : ,a,2,3,4,5 
...
.. figure:: {static}/images/knitr/docs-configuration-demo_cfgs2-1.png
    :align: center
    :alt: Can use multiple configurations stored in an environment at the same time
    :width: 60%
